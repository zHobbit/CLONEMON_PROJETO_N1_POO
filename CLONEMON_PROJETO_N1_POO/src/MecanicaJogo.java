...
public class MecanicaJogo {
    ...
    static Monstros olaf = new Monstros(4, "Gelado", Elementos.GELO, 100, 30, 10, 60, cuboGelo, ficaFrio);
	...
	public void NovaPartida() {
		...
		while(clonemonBatalha < 1 || clonemonBatalha > 3) {
			...
			int movimentoRound = 0, movimentoRoundP2 = 0, clonemonTroca, clonemonTrocaP2;
